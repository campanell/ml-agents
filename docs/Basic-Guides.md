...
TODO: INTRODUCTION 
TODO: add images to each section below
...
Go to your command line, enter the `ml-agents` directory and type: 
...
You can now embed your trained brain by following the steps above:
